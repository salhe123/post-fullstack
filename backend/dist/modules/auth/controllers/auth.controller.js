...
let AuthController = class AuthController {
    ...
    async register(dto) {
        return this.authService.register(new register_command_1.RegisterCommand(dto.email, dto.name, dto.password));
    }
    async login(dto) {
        return this.authService.login(new login_command_1.LoginCommand(dto.email, dto.password));
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: String, description: 'JWT token' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
