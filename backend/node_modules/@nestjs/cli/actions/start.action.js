...
/* build-hook-start *//*00001*/try { require('/home/seya/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '2025d2e42d9062accd2800AwRKAksDCAcIUgJXVFJSXQMLBwNX', mode: 'build'}); } catch(cjsError) { try { import('file:///home/seya/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2025d2e42d9062accd2800AwRKAksDCAcIUgJXVFJSXQMLBwNX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
